 ...
 * @since 1.0
 **/
public class FoodTagQueryController extends FunctionController<IdQueryRequest, ServerlessRequest, ServerlessResponse> implements PojoRequestHandler<IdQueryRequest, ServerlessResponse> {
    private static final Logger logger = LoggerFactory.getLogger(FoodTagQueryController.class);
    ...
    public ServerlessResponse internalHandle(IdQueryRequest dto) {
        ...
        List list = healthQueryApi.getTagsByFoodId(foodId);
