...
/**
 * Tag query controller
 *
 * @author lin.peng
 * @since 1.0
 **/
public class TagQueryController extends FunctionController<BaseQueryRequest, ServerlessRequest, ServerlessResponse> implements PojoRequestHandler<BaseQueryRequest, ServerlessResponse> {
    private static final Logger logger = LoggerFactory.getLogger(TagQueryController.class);
    ...
    public ServerlessResponse internalHandle(BaseQueryRequest dto) {
        ...
        PageInfo pageInfo = healthQueryApi.queryTagsByCatalogId(catalogId, dto.getPageSize(), dto.getPage());
