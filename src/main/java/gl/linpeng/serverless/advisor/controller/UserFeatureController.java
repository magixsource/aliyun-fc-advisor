...
/**
 * User feature controller
 *
 * @author lin.peng
 * @since 1.0
 **/
public class UserFeatureController extends FunctionController<UserFeatureRequest, ServerlessRequest, ServerlessResponse> implements PojoRequestHandler<UserFeatureRequest, ServerlessResponse> {
    ...
    public ServerlessResponse internalHandle(UserFeatureRequest dto) {
        ...
        // init runtime
        initApplication();
        UserFeature userFeature = healthQueryApi.saveUserFeature(dto);
        PayloadResponse payloadResponse = new PayloadResponse("success", userFeature.toMap());
