...
public class UserFeatureDeleteControllerTest {

    private static UserFeatureDeleteController userController;

    @BeforeClass
    public static void init() {
        userController = new UserFeatureDeleteController();
    }

    @Test
    public void testDeleteUserFeature() throws IOException {
